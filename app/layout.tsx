...
export const metadata: Metadata = {
  ...
  keywords: ["AI Blocks", "OpenAI Blocks", "Blocks", "OpenAI Realtime API", "OpenAI Realtime", "OpenAI Realtime WebRTC", "OpenAI Realtime Starter", "Voice AI", "Voice AI components", "web components", "UI components", "UI Library", "shadcn", "aceternity", "AI", "Next.js", "React", "Tailwind CSS", "Framer Motion", "TypeScript", "Design engineer", "shadcn ai"],
};
          ...
          <div className="relative flex min-h-dvh flex-col bg-background items-center">
            ...
            <div className="w-full bg-gradient-to-r from-gray-900 to-gray-700 py-2">
              <div className="container mx-auto px-4 text-center text-white text-sm">
                ...
                <a href="https://blocks.ui" className="underline ml-2 hover:text-gray-200">
                  Learn more →
                </a>
              </div>
            </div>
